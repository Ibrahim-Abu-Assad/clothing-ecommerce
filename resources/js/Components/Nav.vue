<!-- <template>
  <nav class="bg-white shadow p-4 flex justify-between items-center">
    <div class="text-xl font-bold">
      <a href="/" class="hover:text-blue-600">My Shop</a>
    </div>
    <ul class="flex space-x-4">
      <li><inertia-link href="/" class="hover:text-blue-600">Products</inertia-link></li>
      <li><inertia-link href="/cart" class="hover:text-blue-600">Cart</inertia-link></li>
      <li><inertia-link href="/login" class="hover:text-blue-600">Login</inertia-link></li>
    </ul>
  </nav>
</template>
