...
function addToCart() {
    ...
    Inertia.post('/cart', {
        ...
        size_id: selectedSize.value, // Send the ID of the selected size
        color_id: selectedColor.value, // Send the ID of the selected color
                    ...
                    <div class="group relative">
                        <div class="flex gap-2 mb-4 overflow-x-auto pb-2">
                            <img v-for="img in product.images" :key="img.id"
                                :src="img.image_path || 'data:image/jpeg;base64,'"
                                alt="Product Image"
                    ...
                    <div class="px-2 sm:px-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select v-model="selectedSize"
                                ...
                                <option v-for="sizeOption in product.sizes" :key="sizeOption.id" :value="sizeOption.id">
                                    {{ sizeOption.name }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select v-model="selectedColor"
                                ...
                                <option v-for="colorOption in product.colors" :key="colorOption.id" :value="colorOption.id">
                                    {{ colorOption.name }}
                                </option>
                            </select>
                        </div>
